...
public class Manage_Sessions extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(9).setMinWidth(330);
            jTable1.getColumnModel().getColumn(9).setPreferredWidth(330);
            jTable1.getColumnModel().getColumn(9).setMaxWidth(330);
        }
