...
public class sessionRooms extends javax.swing.JInternalFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
            ...
            else if(timeFrom.getSelectedItem() == "Select Time From" || timeTo.getSelectedItem() == "Select Time To")
            {
            ...
            else
            {
                try
                {
                    DataBase.setData("insert into session_room(lecture1,lecture2,session_,room_,date_, from_t, to_t, tag) values('"+sl1+"','"+sl2+"','"+ss+"','"+sr+"', '"+day+"', '"+tf+"', '"+tt+"', '"+tags+"')");
...
//        dateOutLabel.setText(d); 
    ...
    private void dateSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dateSubActionPerformed
        ...
        {
            SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault());
            day = sdf.format(dateChooser.getDate());
            dateOutLabel.setText(day);
            System.out.println("Date" + day.toString());
        }
        catch (Exception e)
        {
            JOptionPane.showMessageDialog(null, "Invalid Date" + e);
        }
